package com.microservice.exam_service.exception.handler;


import com.microservice.exam_service.exception.custom.DuplicateEntryException;
...
import com.microservice.exam_service.exception.model.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> httpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException  ex, HttpServletRequest request) {
        ErrorResponse errorResponse = ErrorResponse.builder()
                ...
                .error(ex.getMessage())
                .message("Please try with correct Http method")
                .path(request.getRequestURI())
                .build();
    ...
    public ResponseEntity<ErrorResponse> httpServerErrorException(Exception  ex, HttpServletRequest request) {
        ErrorResponse errorResponse = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
                .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .error(ex.getMessage())
